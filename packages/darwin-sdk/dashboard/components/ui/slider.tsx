  ...
  return (
    ...
    >
      <SliderPrimitive.Track
        ...
        className="bg-muted/50 border border-border/50 rounded-full data-horizontal:h-2 data-horizontal:w-full data-vertical:h-full data-vertical:w-2 relative grow overflow-hidden data-horizontal:w-full data-vertical:h-full"
      >
